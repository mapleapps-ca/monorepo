...
type CollectionDTORepository interface {
	...
	CreateInCloud(ctx context.Context, collectionDTO *CollectionDTO, accessToken string) (*primitive.ObjectID, error)
	...
	GetFromCloudByID(ctx context.Context, id primitive.ObjectID, accessToken string) (*CollectionDTO, error)
