...
type CollectionDTORepository interface {
	...
	CreateInCloud(ctx context.Context, collectionDTO *CollectionDTO) (*primitive.ObjectID, error)
	...
	GetFromCloudByID(ctx context.Context, id primitive.ObjectID) (*CollectionDTO, error)
