...
type FileDTORepository interface {
	// Upload uploads a FileDTO to the cloud service.
	...
	Upload(ctx context.Context, file *FileDTO) (*primitive.ObjectID, error)

	// DownloadByID downloads a FileDTO by its unique identifier from the cloud service.
	...
	DownloadByID(ctx context.Context, id primitive.ObjectID) (*FileDTO, error)

	// List lists FileDTOs from the cloud service based on the provided filter criteria.
	...
	List(ctx context.Context, filter FileFilter) ([]*FileDTO, error)

	// DeleteByID deletes a FileDTO by its unique identifier from the cloud service.
