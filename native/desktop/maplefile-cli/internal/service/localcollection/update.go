// internal/service/localcollection/update.go
...
type updateService struct {
	logger        *zap.Logger
	updateUseCase uc.UpdateLocalCollectionUseCase
}
...
func (s *updateService) Update(ctx context.Context, input UpdateInput) (*UpdateOutput, error) {
	...
	if input.CollectionType != nil &&
		...
		*input.CollectionType != localcollection.CollectionTypeAlbum {
	...
	useCaseInput := uc.UpdateLocalCollectionInput{
		ID: objectID,
	}
