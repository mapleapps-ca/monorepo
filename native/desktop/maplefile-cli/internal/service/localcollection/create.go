// internal/service/localcollection/create.go
...
type createService struct {
	...
	useCase       uc.CreateLocalCollectionUseCase
}
...
func (s *createService) Create(ctx context.Context, input CreateInput) (*CreateOutput, error) {
	...
	if input.CollectionType == "" {
		...
		input.CollectionType = localcollection.CollectionTypeFolder
	} else if input.CollectionType != localcollection.CollectionTypeFolder && input.CollectionType != localcollection.CollectionTypeAlbum {
	...
	useCaseInput := uc.CreateLocalCollectionInput{
