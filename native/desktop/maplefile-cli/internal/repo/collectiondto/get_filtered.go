...
func (r *collectionDTORepository) GetFilteredCollectionsFromCloud(ctx context.Context, request *collectiondto.GetFilteredCollectionsRequest) (*collectiondto.GetFilteredCollectionsResponse, error) {
	...
	r.logger.Debug("Making request to filtered collections endpoint", zap.String("url", finalURL))
	...
	// Execute the request
	r.logger.Debug("Executing HTTP request for filtered collections")
	...
	// Parse the response
	r.logger.Debug("Parsing HTTP response body into GetFilteredCollectionsResponse")
