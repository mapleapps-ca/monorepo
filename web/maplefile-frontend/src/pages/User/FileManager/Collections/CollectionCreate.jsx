  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-red-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {error && (
          <div className="max-w-2xl mx-auto mb-6 p-4 rounded-lg bg-red-50 border border-red-200 animate-fade-in">
        ...
        {success && (
          <div className="max-w-2xl mx-auto mb-6 p-4 rounded-lg bg-green-50 border border-green-200 animate-fade-in">
            <div className="flex items-center">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <ul className="text-sm text-blue-800 space-y-1">
                  ...
                  <li>
                    • You'll be redirected to your new collection to start
                    adding files
                  </li>
                  <li>
