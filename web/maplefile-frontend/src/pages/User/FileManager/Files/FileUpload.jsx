// File: src/pages/FileManager/Files/FileUpload.jsx
...
const FileUpload = () => {
  ...
  const mockCollections = [
    ...
    { id: "2", name: "Vacation Photos", type: "album" },
    { id: "3", name: "Project Files", type: "folder" },
    { id: "4", name: "Family Album", type: "album" },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div
              ...
              onDrop={handleDrop}
              className={`bg-white rounded-xl border-2 border-dashed transition-all duration-200 ${
            ...
            >
              <div className="p-12 text-center">
                ...
                <label className="inline-flex items-center px-4 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 cursor-pointer transition-all duration-200">
              ...
              <div className="flex items-start">
                ...
                <div className="text-sm text-blue-800">
                  ...
                  <p className="text-xs">
                    ...
                    upload. Your files remain encrypted at rest.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  {isUploading && (
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-gray-900">
                        {completedFiles} of {files.length}
                      </span>
                    </div>
                  )}
                </div>
            ...
            <div className="flex items-center space-x-3">
              {isUploading ? (
                ...
                >
                  ...
                  Uploading {completedFiles}/{files.length} files...
                </button>
              ) : (
                <button
                  onClick={startUpload}
