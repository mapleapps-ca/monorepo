// File: monorepo/web/maplefile-frontend/src/pages/Developer/Login/VerifyOTT.jsx
import React, { useState, useEffect } from "react";
import { useNavigate } from "react-router";
import { useServices } from "../../../services/Services";

const DeveloperVerifyOTT = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate("/developer/login/complete");
    } catch (error) {
...
export default DeveloperVerifyOTT;
