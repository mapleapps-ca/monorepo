// File: monorepo/web/maplefile-frontend/src/pages/Developer/Register/VerifyEmail.jsx
...
const DeveloperVerifyEmail = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate("/developer/register/verify-success");
    } catch (error) {
  ...
  const handleBackToRecovery = () => {
    navigate("/developer/register/recovery");
  };
