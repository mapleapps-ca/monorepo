...
class WorkerManager {
  ...
  // Send current storage data to worker (updated for unencrypted tokens)
  sendStorageDataToWorker() {
    const storageData = {
      // Unencrypted token keys
    ...
    console.log("[WorkerManager] Sending storage data to worker:", {
      hasAccessToken: !!storageData.mapleapps_access_token,
      hasRefreshToken: !!storageData.mapleapps_refresh_token,
  ...
  startMonitoring() {
    ...
    console.log("[WorkerManager] Starting unencrypted token monitoring");
  ...
  // Manual token refresh (updated for unencrypted tokens)
  async manualRefresh() {
    if (!this.isInitialized) {
    ...
    return new Promise((resolve, reject) => {
      ...
      // Send refresh request with unencrypted refresh token
  ...
  // Get current storage data (updated for unencrypted tokens)
