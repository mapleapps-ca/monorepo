// monorepo/cloud/mapleapps-backend/internal/maplefile/interface/http/middleware/jwt.go
package middleware
...
func (mid *middleware) JWTProcessorMiddleware(fn http.HandlerFunc) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		// log.Printf("monorepo/cloud/mapleapps-backend/internal/maplefile/interface/http/middleware/jwt.go --> reqToken: %v\n", reqToken)
